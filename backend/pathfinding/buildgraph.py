...
def build_graph_on_quadtree(qtree: QuadTree, mode: VertMode = VertMode.CORNERS, return_vertex_dict: bool = False, quality=20) -> tuple[Graph, dict[QuadTree, list[Waypoint]]]:
